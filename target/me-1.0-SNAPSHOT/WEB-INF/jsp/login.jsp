...
<div class="container" style="position: relative">
    <div class="content" >
        <div class="layui-container" style="position: absolute;top:250px;left: 580px">
            <div class="admin-login-background">
                <div class="layui-form login-form" style="">
                    <form class="layui-form " id="myForm" action="">
                        <div class="layui-form-item logo-title">
                            <br>
                            <h1 style="text-align:center;font-size: 18px;">超市进销存管理</h1>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-icon layui-icon-username" ></label>
                            <input type="text" name="mname" lay-verify="required|account" placeholder="用户名" autocomplete="off" class="layui-input" value="">
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <button type="button" class="layui-btn layui-btn layui-btn-normal layui-btn-fluid" lay-submit="" lay-filter="login">登 入</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="footer" style="">
            <svg id="scene" x="0px" y="0px" width="1500px" height="305px">
